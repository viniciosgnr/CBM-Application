...
const mockWorkOrders = [
  // UNY FPSO
  {
    reference: '1089487',
    fpso: 'UNY',
    description: 'Instrumentation Failure: Verify proper sensor fastening and check connector integrity.',
    priority: 'Accepted',
    status: 'Accepted',
    tagNumber: 'COCE_TIME_NRS_02',
    tagDescription: 'Instrument Air Compressor B',
    monitoringTechnique: 'CBM Vibration - Analysis High',
    creationDate: '13/04/2026, 10:00:00',
    dueDate: '13/05/2026, 10:00:00',
    reportId: 1,
    woSite: 'UNY',
    ...
    faultDesc: 'Instrumentation Failure: Verify proper sensor fastening and check connector integrity.',
    symptom: 'VIB',
    discovery: '04',
    actionId: '6',
  ...
  },
  {
    reference: '1091666',
    fpso: 'DNY',
    description: 'Instrumentation failure: Verify axial clearance and adjust zero position voltage setpoint.',
    priority: 'Accepted',
    status: 'Accepted',
    tagNumber: 'DNY_126-PUCE-0710',
    tagDescription: 'HP Feed Pump Gearbox A',
    monitoringTechnique: 'CBM Vibration - Analysis High',
    creationDate: '25/05/2026, 09:30:00',
    dueDate: '25/06/2026, 09:30:00',
    woSite: 'DNY',
    directive: 'CHECK SENSOR GAP',
    maintOrg: 'MECHTS',
    workType: 'CM',
    externalSource: 'CBM-VIB/H',
    externalSourceId: 'CBM-1091666',
    faultDesc: 'Instrumentation failure: Verify axial clearance and adjust zero position voltage setpoint.',
    symptom: 'VIB',
    discovery: '04',
    actionId: '7',
    operationalStatus: '01',
  },
  {
    reference: '1091314',
    fpso: 'DNY',
    description: 'Instrumentation failure: Inspect the sensor loop in the next opportunity.',
    priority: 'Pending',
    status: 'Pending',
    tagNumber: 'DNY_115-PUCE-9503-A',
    tagDescription: 'Gas Turbine Generator A',
    monitoringTechnique: 'CBM Thermography - Analysis',
    creationDate: '19/05/2026, 11:00:00',
    dueDate: '19/06/2026, 11:00:00',
    woSite: 'DNY',
    directive: 'INSPECT SENSOR LOOP',
    maintOrg: 'INSTR',
    workType: 'CM',
    externalSource: 'CBM-VIB/L',
    externalSourceId: 'CBM-1091314',
    faultDesc: 'Instrumentation failure: Inspect the sensor loop in the next opportunity.',
    symptom: 'STD',
    discovery: '04',
    actionId: '6',
    operationalStatus: '01',
  },
  {
    reference: '1089485',
    fpso: 'ONE',
    description: 'Instrumentation failure: Check gap voltage for each sensor and verify axial clearance.',
    priority: 'Accepted',
    status: 'Completed',
    tagNumber: 'ONE_662-PUCE-0030A',
    tagDescription: 'Water Injection Pump Gearbox B',
    monitoringTechnique: 'CBM Vibration - Analysis High',
    creationDate: '19/03/2026, 10:00:00',
    dueDate: '19/04/2026, 10:00:00',
    woSite: 'ONE',
    directive: 'CHECK SENSOR GAP',
    maintOrg: 'MECHTS',
    workType: 'CM',
    externalSource: 'CBM-VIB/H',
    externalSourceId: 'CBM-1089485',
    faultDesc: 'Instrumentation failure: Check gap voltage for each sensor and verify axial clearance.',
    symptom: 'ELP',
    discovery: '04',
    actionId: '9',
    operationalStatus: '01',
